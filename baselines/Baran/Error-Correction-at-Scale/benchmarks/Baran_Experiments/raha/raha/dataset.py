...
class Dataset:
    ...
    def get_data_cleaning_evaluation(self, correction_dictionary, sampled_rows_dictionary=False):
            ...
            if (not sampled_rows_dictionary) or (cell[0] in sampled_rows_dictionary):
                ...
                if cell in actual_errors:
                    ...
                    if correction_dictionary[cell] == actual_errors[cell]:
                        ec_tp += 1.0
                        true_postives_cells.append(cell)
                    else:
                        false_positives_cells[str(cell)] = correction_dictionary[cell]
        ...
        metrics = {"ed_p": ed_p, "ed_r": ed_r, "ed_f": ed_f, "ed_tp": ed_tp,
                   ...
                   "output_size": output_size, "actual_errors": len(actual_errors), "true_postives_cells": true_postives_cells,
                     "false_positives_cells": false_positives_cells
                   }
        return metrics
    ...
    def get_data_cleaning_evaluation_selected_col(self, correction_dictionary, sampled_rows_dictionary, col_idx):
        ...
        metrics = {"ed_p": ed_p, "ed_r": ed_r, "ed_f": ed_f, "ed_tp": ed_tp,
                   ...
                   "true_postives_cells": true_postives_cells,
                     "false_positives_cells": false_positives_cells
                   }
        return metrics
########################################
