...
def run_experiment_enough_labels():
    print("Running experiment...")
    result = subprocess.run([
        sys.executable, 
        "raha/ecs_run_experiments/baran_enough_labels_lake.py"
...
class LakeCorrectionExperimentRunner:
    ...
    def run_experiment(self) -> None:
        ...
        run_experiment_enough_labels()


if __name__ == "__main__":
    dataset_names = ["merged"]  # Add more dataset names as needed
    datasets_path = "/home/fatemeh/data/cells-limit/LakeCorrectionBench/datasets/Real_Lake_Default_Datasets/merged_strings_default_set_union/mit_dwh"
    
    shared_runner = LakeCorrectionExperimentRunner("/home/fatemeh/data/LakeCorrectionBench/Baran/Error-Correction-at-Scale/benchmarks/Baran_Experiments/raha/raha/ecs_run_experiments/hydra_configs/shared.yaml")
    ...
    for dataset_name in dataset_names:
        full_shared_config = {
            "shared": {
                ...
                "results_path": "/home/fatemeh/data/LakeCorrectionBench/results_mit_pm_runtime", 
