...
def main():
    ...
    parser.add_argument(
        "--results-dir", "-r",
        default=str(Path(__file__).resolve().parents[2] / "results" / "holoclean" / "output"),
    ...
    parser.add_argument(
        "--name-dict", "-n",
        default=str(Path(__file__).resolve().parents[2] / "results" / "holoclean" / "open_data_uk_res_dict.pkl"),
