...
def rename_and_copy_dirs(input_path, output_path):
    ...
    return res_dict
# Example usage
input_path = str(Path(__file__).resolve().parents[2] / 'datasets' / 'real_lakes' / 'open_data_uk')
output_path = str(Path(__file__).resolve().parent / 'datasets-holo' / 'open_data_uk')
