...
PICKLE_PATH = str(Path(__file__).resolve().parent / 'datasets-holo' / 'open_data_uk_name_map.pkl')
DATASETS_DIR = str(Path(__file__).resolve().parents[2] / 'datasets' / 'real_lakes' / 'open_data_uk')
