...
def run_metanome_with_cli(file_path):
    ...
    if system == "Windows":
        ...
        val = subprocess.check_call(
            f"java -cp \"/home/fatemeh/LakeCorrectionBench/HoloClean/HoloFDExtractor/DataLakeFDExtractor/metanome-cli-1.2-SNAPSHOT.jar:/home/fatemeh/LakeCorrectionBench/HoloClean/HoloFDExtractor/DataLakeFDExtractor/HyFD-1.2-SNAPSHOT.jar\" de.metanome.cli.App --algorithm de.metanome.algorithms.hyfd.HyFD --files \"{file_path}\" --file-key \"INPUT_GENERATOR\" --header --separator \",\" -o \"file:clean\"",
